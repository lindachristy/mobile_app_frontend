  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <View style={styles.dotsRow}>
        {slides.map((_, i) => (
          <View key={i} style={[styles.dot, { backgroundColor: theme.dot }, i === currentIndex && { backgroundColor: theme.dotActive, width: 20 }]} />
        ))}
      </View>

      <View style={styles.buttons}>
        {isLast ? (
          <TouchableOpacity style={[styles.continueBtn, { backgroundColor: theme.btnPrimary }]} onPress={handleContinue}>
