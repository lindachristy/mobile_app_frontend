...
const questions: Question[] = [
  ...
  },
  {
    ...
    content:
      "Yeah the question get more easier right, Let's answer and don't forgot to enjoy.",
    options: [
  ...
  {
    header:
      "Which of the following is a tool for managing versions of your code?",
  ...
  },
  {
    ...
    options: [
      "To repeat a code number of times",
  ...
  {
    header:
      "Which of these elements can store multiple values in a single variable in JavaScript?",
    ...
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <TouchableOpacity
        style={[
          ...
          {
            backgroundColor:
              selectedOption !== null ? theme.btnPrimary : "#ccc",
          },
        ]}
