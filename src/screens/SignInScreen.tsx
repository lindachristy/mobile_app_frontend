  ...
  return (
    <ScrollView
      ...
      <View style={styles.form}>
        ...
        <View style={styles.rememberRow}>
          <TouchableOpacity style={styles.checkboxRow} onPress={() => setRemember(r => !r)}>
            <View style={[styles.checkbox, { borderColor: theme.btnPrimary, backgroundColor: remember ? theme.btnPrimary : 'transparent' }]}>
      ...
      <View style={styles.buttons}>
        ...
        <TouchableOpacity style={[styles.signInBtn, { backgroundColor: theme.btnPrimary }]}>
