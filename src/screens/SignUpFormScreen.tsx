  ...
  return (
    <ScrollView
      ...
      <Text style={[styles.subHeading, { color: theme.subtext }]}>
        Join now to be a pro at coding
      </Text>
      ...
      <View style={styles.form}>
        ...
        <TouchableOpacity style={styles.checkboxRow} onPress={() => setAgreed(a => !a)}>
          <View style={[styles.checkbox, { borderColor: theme.btnPrimary, backgroundColor: agreed ? theme.btnPrimary : 'transparent' }]}>
            {agreed && <Text style={styles.checkmark}>✓</Text>}
          </View>
          <Text style={[styles.checkboxTxt, { color: theme.subtext }]}>
            I Agree to Codu.id{' '}
            <Text style={{ color: theme.btnPrimary, textDecorationLine: 'underline' }}>
              Term and Condition
            </Text>
          </Text>
        </TouchableOpacity>
      ...
      <View style={styles.buttons}>
        ...
        <TouchableOpacity style={[styles.signupBtn, { backgroundColor: theme.btnPrimary }]}>
