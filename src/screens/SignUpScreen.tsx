  ...
  return (
    <ScrollView
      ...
      <Text style={[styles.subHeader, { color: theme.subtext }]}>
        Log in before you start learning
      </Text>
      ...
      <TouchableOpacity style={[styles.signUpBtn, { backgroundColor: theme.btnPrimary }]} onPress={() => navigation.navigate('SignUpForm')}>
        <Text style={[styles.signUpTxt, { color: theme.btnPrimaryText }]}>Sign up</Text>
      </TouchableOpacity>

      <TouchableOpacity style={[styles.signInBtn, { borderColor: theme.btnPrimary }]} onPress={() => navigation.navigate('SignIn')}>
